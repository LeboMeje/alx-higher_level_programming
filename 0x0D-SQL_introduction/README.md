# MySQL - Introduction
Project done during **Full Stack Software Engineering studies** at **ALX SE SCHOOL**. It aims to learn about databases, relational databases, subqueries, tables, **MySQL** statements and functions.

## Technologies
* `MySQL 5.7` (version 8.0.25)
